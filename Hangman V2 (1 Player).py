...
while again == "y":
    ...
    def letterCorrect(x, xLetter):
        ...
        y = -200
        if guess == xLetter and not xLetter == " " and not xLetter in oldCorrectLetters:
            newNumberCorrect += 1
            turtle.up()
            turtle.setpos(x, y)
    ...
    # Word setup
    word = r.get_random_word(hasDictionaryDef="true", minLength=3, maxLength=10, minDictionaryCount=8,
